export const Data = {
  Titles: {
    Home: 'Home | The Trade Insight',
    Login: 'Login | The Trade Insight',
    Signup: 'Welcome | The Trade Insight',
    Overview: 'Dashboard | The Trade Insight',
    History: 'History | The Trade Insight',
    Watchlist: 'Watchlist | The Trade Insight',
    Insider: 'Insider | The Trade Insight',
    Scanner: 'Scanner | The Trade Insight',
    FillingScanner: 'FillingScanner',
    Finance: 'Finance | The Trade Insight',
  },
  NavItems: [
    {
      Name: 'Features',
    ...
    {
      Name: 'Docs',
      Route: 'https://the-traders-insight.gitbook.io/the-traders-insight/',
    },
    {
      Name: 'Contact',
      ScrollTo: 'Contact',
